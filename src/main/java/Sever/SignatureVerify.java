...
public class SignatureVerify {
    /**
     * @param Pku: 用户公钥
     * @param commitmentAndSignature: 知识承诺j1 j2 及 知识签名SPK1
     * @return boolean
     * @author xjm
     * @description 根据以上参数，验证用户签名的有效性
     * @date 5/10/2024 9:51 PM
     */
    public static boolean verify(BigInteger Pku, CommitmentAndSignature commitmentAndSignature) throws NoSuchAlgorithmException {
        BigInteger j1 = commitmentAndSignature.getJ1();
        BigInteger j2 = commitmentAndSignature.getJ2();
        ArrayList<BigInteger> SPK1 = commitmentAndSignature.getSPK1();
